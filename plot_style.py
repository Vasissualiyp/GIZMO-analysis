...
PLOT_STYLES = {
    ...
    "fig_xi_gamma": PlotStyle(  # xi_gamma_combined.pdf
        font_size=40,
        tick_label_size=40,
        axis_label_size=40,
        legend_font_size=36,
    ...
    #    legend_handle_length = 2.0,
    # ),
    "fig_stability": PlotStyle(  # stability_criteria_master.pdf
        font_size=40,
        tick_label_size=36,
        axis_label_size=44,
        legend_font_size=34,
...
def apply_style(name_or_style) -> PlotStyle:
    ...
    style = (
        PLOT_STYLES[name_or_style] if isinstance(name_or_style, str) else name_or_style
    )
    plt.rcParams.update(
        {
